...
3) Edit `config.py` file and change default values of `HTTP_USERS` and `HTTP_PATH` values to secure your server installation. Default configuration file have the following values:
